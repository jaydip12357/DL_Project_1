...
from website.api_client import get_prediction, check_model_health, ModelAPIError


class TestCheckModelHealth:
    """Tests for the health check function."""
    
    @patch('website.api_client.Config')
    @patch('website.api_client.requests.get')
...
class TestGetPrediction:
    ...
    @patch('website.api_client.Config')
    @patch('website.api_client.requests.post')
